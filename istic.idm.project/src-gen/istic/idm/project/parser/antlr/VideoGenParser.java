...
public class VideoGenParser extends org.eclipse.xtext.parser.antlr.AbstractAntlrParser {
	...
	@Override
	protected istic.idm.project.parser.antlr.internal.InternalVideoGenParser createParser(XtextTokenStream stream) {
		return new istic.idm.project.parser.antlr.internal.InternalVideoGenParser(stream, getGrammarAccess());
	}
