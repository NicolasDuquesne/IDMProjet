...
public class PlaylistPackageImpl extends EPackageImpl implements PlaylistPackage {
	 ...
	 * @generated
	 */
	public EAttribute getVideo_Uri() {
	 ...
	 * @generated
	 */
	public EAttribute getVideo_DurationSeconds() {
	 ...
	 * @generated
	 */
	public EAttribute getPlaylist_ListVideo() {
	...
	public void createPackageContents() {
		...
		createEAttribute(videoEClass, VIDEO__URI);
		createEAttribute(videoEClass, VIDEO__DURATION_SECONDS);

		playlistEClass = createEClass(PLAYLIST);
		createEAttribute(playlistEClass, PLAYLIST__LIST_VIDEO);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getVideo_Uri(), ecorePackage.getEString(), "uri", null, 0, 1, Video.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getVideo_DurationSeconds(), ecorePackage.getEInt(), "durationSeconds", null, 0, 1, Video.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(playlistEClass, Playlist.class, "Playlist", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getPlaylist_ListVideo(), ecorePackage.getEEList(), "listVideo", null, 0, 1, Playlist.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
